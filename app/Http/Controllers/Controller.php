    ...
    public function CreateTable($id){
        ...
        if($master_user){
            ...
            if (!Schema::hasTable($storeId.'_tc_users_role')){  
                ...
                Schema::table($storeId.'_tc_users_role', function (Blueprint $table) use ($storeId) {
                    if (!Schema::hasColumn($storeId.'_tc_users_role', 'id')) {
                        $table->integer('id');
                    }
                });
            }
            ...
            if (!Schema::hasTable($storeId.'_tc_business_details')){   
                Schema::create($storeId.'_tc_business_details', function (Blueprint $table) {
