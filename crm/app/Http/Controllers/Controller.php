    ...
    public function CreateTable($id)
    {
        ...
        if (!Schema::hasTable($storeId.'_tc_trip_preference')){   
            Schema::create($storeId.'_tc_trip_preference', function (Blueprint $table) use ($storeId) {
                ...
                $table->text('curuise_note')->nullable();
                ...
                $table->text('resort_notes')->nullable();
                ...
                $table->text('guided_tours_notes')->nullable();
                ...
                $table->text('car_rental_notes')->nullable();
                ...
                $table->text('theme_park_notes')->nullable();
            ...
            Schema::table($storeId.'_tc_trip_preference', function (Blueprint $table) use ($storeId) {
                if (!Schema::hasColumn($storeId.'_tc_trip_preference', 'traveler_id')) {
                    $table->string('traveler_id')->nullable();
                }
            });
        }
            ...
            foreach ($trips as $trip) {
               ...
               // dd($trip->uniqueId);
                ...
                $tripData = [
                    ...
                    'tr_traveler_id' => $trip->tr_traveler_id ?? '',
                    'tr_traveler_name' => $trip->trtm_first_name ?? '',
                    'tr_dob'           => $tr_dob ?? '',
                    'tr_age'           => $trip->tr_age ?? '',
