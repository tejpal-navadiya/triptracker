...
<x-guest-layout>
    ...
    @endif
    <form method="POST"
    action="{{ route('masteradmin.userdetail.storePassword', ['user_id' => $user_id]) }}">
        @csrf
        ...
        <x-text-input id="user_email" class="form-control" type="email" name="user_email" :value="old('user_email', $email)" required autofocus autocomplete="username" placeholder="Email" readonly />
