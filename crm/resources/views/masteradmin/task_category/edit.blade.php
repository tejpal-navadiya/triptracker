            ...
            <section class="content px-10">
                <div class="container-fluid">
                    ...
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <form method="POST"
                            action="{{ route('task-category.update', $task_categories->task_cat_id) }}"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <x-text-input type="text" class="form-control" id="task_cat_name"
                                                ...
                                                autocomplete="task_cat_name" :value="old('task_cat_name', $task_categories->task_cat_name ?? '')" />
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="task_cat_status" name="task_cat_status"
                                                autofocus>
                                                <option value="1"
                                                    {{ $task_categories->task_cat_status == 1 ? 'selected' : '' }}>Active
                                                </option>
                                                <option value="0"
                                                    {{ $task_categories->task_cat_status == 0 ? 'selected' : '' }}>
                                                    Deactive</option>
                                            </select>
