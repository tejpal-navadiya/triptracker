    ...
    <div class="col-lg-12 card-body3">
        ...
        <div class="card-body d-flex data-tab-content">
            ...
            <table class="table card-body-table" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td><p class="company_business_name">Total Person : {{ $memberTotalCount ?? '0' }}</p></td>                    
                </tr>                
            </table>

            <table class="table card-body-table" cellpadding="0" cellspacing="0">
                <tr>
                    <td><p class="company_business_name">Phone Number : {{ $trip->tr_phone ?? '' }}</p></td>
                </tr>
                <tr>
                    <td><p class="company_business_name">Trip Number : {{ $trip->tr_number ?? '' }}</p></td>
                </tr>
            </table>
