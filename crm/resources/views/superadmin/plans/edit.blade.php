...
<head>
    ...
    <title>Trip Tracker | Edit subscription Plans</title>
                ...
                <div class="container-fluid">
                    <div class="row mb-2 align-items-center">
                        ...
                        <div class="col-sm-6">
                            ...
                            <button type="submit" form="planForm" class="add_btn px-10">Save</button>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Edit Subscription Plans</h3>
                        </div>
                        <?php //dd($plan);
                        ?>
                        <form id="planForm" method="POST" action="{{ route('plans.update', ['plan' => $plan->sp_id]) }}">
                            @csrf
                            @method('PUT')
