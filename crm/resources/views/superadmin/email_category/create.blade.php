...
<head>
    ...
    <title>Add Email Category Details | Trip Tracker</title>
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2 align-items-center justify-content-between">
                        <div class="col">
                        <div class="d-flex">
                            <h1 class="m-0">{{ __('Add Email Category') }}</h1>
                            <ol class="breadcrumb ml-auto">
                                <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Analytics</a></li>
                                <li class="breadcrumb-item active">{{ __('Add Email Category') }}</li>
                            </ol>
                            </div>
                        </div><!-- /.col -->
            ...
            <section class="content px-10">
                <div class="container-fluid">
                    ...
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <form id="emailForm" method="POST" action="{{ route('email-categories.store') }}"
                            ...
                            <div class="card-body2">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <x-text-input type="text" class="form-control" id="email_cat_name"
                                                ...
                                                autocomplete="email_cat_name" value="{{ old('email_cat_name') }}" />
                                ...
                                <div class="row py-20 px-10">
                                    <div class="col-md-12 text-center">
                                        <a href="{{ route('email-categories.index') }}" class="add_btn_br px-10">Cancel</a>
