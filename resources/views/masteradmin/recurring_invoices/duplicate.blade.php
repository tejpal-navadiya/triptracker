                ...
                <table class="table table-hover text-nowrap dashboard_table item_table" id="dynamic_field">
                  ...
                  @foreach($reinvoicesItems as $item)
                    <tr class="item-row">
                        ...
                        <td><input type="number" class="form-control" name="items[][sale_estim_item_qty]" value="{{ $item->sale_re_inv_item_qty }}" placeholder="Enter item Quantity">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control form-controltext" name="sale_estim_item_discount"
                        aria-describedby="inputGroupPrepend" value="{{ $reinvoices->sale_re_estim_item_discount }}" placeholder="Enter a discount value">
